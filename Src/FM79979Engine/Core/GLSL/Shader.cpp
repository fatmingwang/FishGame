...
namespace FATMING_CORE
{
	...
	cBaseShader::cBaseShader(WCHAR*e_strName,bool e_bTexture)
	{
	...
	cBaseShader::cBaseShader(char*e_strVS,char*e_strPS,WCHAR*e_strName,bool e_bTexture)
	{
		this->SetName(e_strName);
		m_bTexture = e_bTexture;
		m_uiTexLoacation = m_uiColorLoacation = m_uiMatrixVPLoacation = m_uiMatrixWLoacation = -1;
	...
	bool	cBaseShader::CreateVS(char*e_strVS)
	{
	...
	bool	cBaseShader::CreateFS(char*e_strPS)
	{
	...
	bool	cBaseShader::CreateProgram(char*e_strVS,char*e_strPS,bool e_bTexture)
	{
