...
namespace FATMING_CORE
{
	...
	//bad design here because cCurveWithTime and cFMAnimationRule both has a virtual function Start and update
	//if it occur ambigous make sure what function u real want
	//ex:((cFMAnimationRule*)(l_p))->Update or ((cCurveWithTime*)(l_p))->Update
	//================
	...
	public:
		...
		//prevent ambiguous
		inline	virtual void	Init(){ cFMAnimationRule::Init(); }
		//prevent ambiguous
		inline	virtual void	Render(){ cFMAnimationRule::Render(); }
		//prevent ambiguous
		inline	virtual void	Update(float e_fElpaseTime){ cFMAnimationRule::Update(e_fElpaseTime); }
		...
		static					cCueToStartCurveWithTime*		GetMe(TiXmlElement*e_pElement);
	};
