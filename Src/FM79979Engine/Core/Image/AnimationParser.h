...
namespace FATMING_CORE
{
	...
	public:
		...
		cMPDIList*GetMPDIListByFileName(const WCHAR*e_strFileName,bool e_bShowErrorMessage = false);
		cMPDIList*GetMPDIListByFileName(const char*e_strFileName,bool e_bShowErrorMessage = false);
		cMPDIList*GetMPDIList(const char*e_strFileName,const WCHAR*e_strName,bool e_bShowErrorMessage = false);
