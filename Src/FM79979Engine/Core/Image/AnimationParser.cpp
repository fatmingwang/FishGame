...
namespace FATMING_CORE
{
	...
	cMPDIList*cAnimationParser::GetMPDIListByFileName(const WCHAR*e_strFileName,bool e_bShowErrorMessage)
	{
		std::string	l_strFileName = UT::WcharToChar(e_strFileName);
		return GetMPDIList(l_strFileName.c_str(),cMPDIList::FileToMPDIListName(e_strFileName).c_str());
	}

	cMPDIList*cAnimationParser::GetMPDIList(const char*e_strFileName,const WCHAR*e_strName,bool e_bShowErrorMessage)
	{
