...
namespace FATMING_CORE
{
 ...
 //   g_pMultiPathDynamicImage->Update(e_fElpaseTime);
	...
	public:
		...
		static			cMultiPathDynamicImage*		GetMe(TiXmlElement*e_pElement);
	};
	...
	public:
		...
		//
		float GetTotalPlaySec(){ return m_pCurrentMultiPathDynamicImage->GetEndTime(); }
		...
		static  std::wstring FileToMPDIListName(const WCHAR*e_strObjectName);
