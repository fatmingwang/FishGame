...
namespace FATMING_CORE
{
	...
	public:
		...
		static	cPuzzleImageUnit*		GetMe(TiXmlElement*e_pElement);
	};
	//================
	...
	public:
		...
		cNumeralImage*	GetNumerialImageByName(const WCHAR*e_strNumerImageName);
		cNumeralImage*	GetNumerialImageByName(const WCHAR*e_str0ImaneName,const WCHAR*e_str9ImaneName);
		float*   GetAllChildrenTriangleStripUV();
		float*   GetAllChildrenTwoTriangleUV();
		//
		static	std::string			GetFileName(const WCHAR*e_strObjectName);
