...
namespace FATMING_CORE
{
	...
	bool	cSoundParser::AddStreamingSound(NamedTypedObject*e_pRef,char*e_strFileName)
	{
		return true;
	}
	...
	bool	cSoundParser::AddStaticSound(NamedTypedObject*e_pRef,const char*e_strFileName)
	{
		...
		{
			cOpanalWAV*	l_pOpanalWAV = new cOpanalWAV(0,e_strFileName);
		...
		{
			cOpanalOgg*	l_pOpanalOgg = new cOpanalOgg(0,e_strFileName);
