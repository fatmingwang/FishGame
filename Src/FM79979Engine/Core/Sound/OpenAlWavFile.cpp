...
namespace FATMING_CORE
{
	...
	cOpanalWAV::cOpanalWAV(NamedTypedObject*e_pNamedTypedObject,const char*e_strileName):cBasicSound(e_pNamedTypedObject)
	{
	...
	void	cOpanalWAV::OpenFile(const char*e_strileName)
	{
		check();
		ALvoid*l_pData = 0;
		ALboolean l_loop;
