...
namespace FATMING_CORE
{
    ...
    public :
        ...
        cScroller(cPuzzleImage*e_pPI,Vector4 e_vTotalViewRect,cClickMouseBehavior*e_pCancelButton = 0,bool e_bHorizontal = true,cPuzzleImageUnit*e_pIcon = 0,Vector3* e_pvIconPos = 0);
		cScroller(std::vector<cBaseImage*>*e_pImageList,Vector4 e_vTotalViewRect,cClickMouseBehavior*e_pCancelButton = 0,bool e_bHorizontal = true,cPuzzleImageUnit*e_pIcon = 0,Vector3* e_pvIconPos = 0);
        virtual ~cScroller();
		//
		...
		const WCHAR*	GetSelectedIndexName();
	};
//end namespace
};
#endif