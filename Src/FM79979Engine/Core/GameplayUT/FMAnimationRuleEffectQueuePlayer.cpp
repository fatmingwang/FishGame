...
namespace FATMING_CORE
{
	...
	cFMARQueuePlayer::cFMARQueuePlayer(cFMARQueuePlayer*e_pFARQueuePlayer):cFatmingGroupBehaviorList<cFMAnimationRule>(e_pFARQueuePlayer)
	{
		m_pFMAnimationRule = 0;
		if( e_pFARQueuePlayer->m_pFMAnimationRule )
			m_pFMAnimationRule = dynamic_cast<cFMAnimationRule*>(e_pFARQueuePlayer->m_pFMAnimationRule->Clone());
	}
	...
	void	cFMARQueuePlayer::ProcssParticleEffect(TiXmlElement*e_pElement)
	{
		...
		if( l_pFMAnimationRule )
			m_pFMAnimationRule = dynamic_cast<cFMAnimationRule*>(l_pFMAnimationRule->Clone());
    ...
    void	cFMARQueuePlayer::InternalInit()
	{
		...
		cFatmingGroupBehaviorList<cFMAnimationRule>::InternalInit();
	}
    ...
    void	cFMARQueuePlayer::InternalRender()
	{
		...
		//cFatmingGroupBehaviorList<cFMAnimationRule>::Render();
	...
	void	cFMARQueuePlayer::SetData(void*e_pData)
	{
		...
		cFatmingGroupBehaviorList<cFMAnimationRule>::SetData(e_pData);
	}
