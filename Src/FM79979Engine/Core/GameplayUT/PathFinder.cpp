...
namespace FATMING_CORE
{
	...
	bool	cLinkedNodes::FindTargetNode(cLinkedNodes*e_pTarget,cNamedTypedObjectVector<cLinkedNodes>*ParentPath,cNamedTypedObjectVector<cNamedTypedObjectVector<cLinkedNodes> >*e_pResultPathes,bool e_bFindShoest)
	{
