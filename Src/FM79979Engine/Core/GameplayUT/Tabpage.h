...
namespace FATMING_CORE
{
	...
	protected:
		...
		//it won't be delete,just a point reference
		GET_SET_DEC(cRenderObjectBehavior*,m_pBG,GetBG,SetBG);;
	public:
		cTabPage();
		cTabPage(Vector4 e_vWorkingZone,cClickMouseBehavior*e_pCancelButton = 0,cBaseImage*e_pIcon = 0,Vector3 *e_pvIconPos = 0,bool e_bForceSetCancelButtonPos = false);
