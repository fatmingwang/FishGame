...
namespace FATMING_CORE
{
    ...
    //=============================================
    template<class T>   class cClickMouseBehaviorList:public cNamedTypedObjectVector<T>,public cClickMouseBehavior
    {
    ...
    public:
        cClickMouseBehaviorList(){ this->m_pCurrentMouseDownCollidedObject = 0;this->m_pCurrentWorkingObject = 0; this->m_bClickMouseBehaviorSatisfied = false;	 m_pTopClickMouseBehavior = 0;m_bReclickable = false; }
		cClickMouseBehaviorList(cClickMouseBehaviorList<T>*e_pClickMouseBehaviorList):cNamedTypedObjectVector<T>(e_pClickMouseBehaviorList),cClickMouseBehavior(e_pClickMouseBehaviorList)
		{
        ...
        virtual ~cClickMouseBehaviorList(){}
  ...
  //          }		
    ...
    public:
		cDoAllMouseBehaviorList(cDoAllMouseBehaviorList<T>*e_pcDoAllMouseBehaviorList):cClickMouseBehaviorList<T>(e_pcDoAllMouseBehaviorList){ m_bAllObjectsDoneToSatisfied = e_pcDoAllMouseBehaviorList->m_bAllObjectsDoneToSatisfied; }
   ...
   //     inline  virtual   void    Init()
   //     {
			//cClickMouseBehaviorList<T>::Init()
   //     }
		...
		inline  virtual   void    MouseUp(int e_iPosX,int e_iPosY)
		{
            ...
            for( int i=0;i<l_iCount;++i )
            {
				...
				{
					if( cClickMouseBehaviorList<T>::m_pCurrentMouseDownCollidedObject == cNamedTypedObjectVector<T>::m_ObjectList[i] )
					{
						cClickMouseBehaviorList<T>::m_pCurrentWorkingObject = cClickMouseBehaviorList<T>::m_pCurrentMouseDownCollidedObject;
						cClickMouseBehavior::m_bCollided = true;
					}
				}
            }
