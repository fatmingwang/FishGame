...
std::wstring	DecodeStringFromeValue(WCHAR*e_strEncrypt,WCHAR*e_strCharacterToSplit)
{
	unsigned char	l_strtemp[79979];
	WCHAR*l_strStart = wcstok(e_strEncrypt,e_strCharacterToSplit);
	int	l_iCount = 0;
	while( l_strStart )
	{
...
std::wstring	EncodeStringToValue(WCHAR*e_strString,WCHAR*e_strCharacterToSplit)
{
	std::wstring	l_strResult;
