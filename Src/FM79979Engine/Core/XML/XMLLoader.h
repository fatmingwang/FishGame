...
#define DEFINE_FILE_EXTENSION_NAME_INFO() \
	...
	public:
		...
		virtual	bool	Parse(const WCHAR*e_strFileName,bool e_bShowLoadingState = false);
		...
		bool	Export(const WCHAR*e_strFileName,bool e_bBinary = false);
	};
	...
	public:
		...
		virtual	bool	ParseDataIntoXMLNode(const WCHAR*e_strText);
