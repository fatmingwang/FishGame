...
namespace FATMING_CORE
{
	...
	void	cLevelLayerGridData::SetImage(cRenderObjectBehavior*e_pRenderObjectBehavior)
	{
		SAFE_DELETE(m_pImage);
		if(e_pRenderObjectBehavior)
		{
			m_pImage = dynamic_cast<cRenderObjectBehavior*>(e_pRenderObjectBehavior->Clone());
