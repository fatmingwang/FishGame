...
#include "targetver.h"
#include "test.h"
#include "../EngineTest/WorldTripSlotApp.h"
#include "Windowsx.h"
...
//SystemParametersInfo(SPI_GETWORKAREA,0,&rect,0);
	...
	g_pGameApp = new cWorldTripSlotApp(g_hWnd,cGameApp::m_svGameResolution,Vector2(cGameApp::m_svViewPortSize.Width(),cGameApp::m_svViewPortSize.Height()));
	if( g_pGameApp  )
		g_pGameApp->Init();
